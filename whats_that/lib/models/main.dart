  ...
  Widget build(BuildContext context) {
    return StreamProvider<Users>.value(
      ...
      child: MaterialApp(
          ...
          routes: {
            '/': (context) => Wrapper(),
            '/tip_off_screen': (context) => WhatsthatPage(),
...
class WhatsthatPage extends StatefulWidget {
  WhatsthatPage({Key key}) : super(key: key);

  _WhatsthatPageState createState() => _WhatsthatPageState();
}

class _WhatsthatPageState extends State<WhatsthatPage> {
